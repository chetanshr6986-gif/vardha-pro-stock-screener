...
def analyze_symbol(
    ...
    try:
        ...
        # A BUY/SELL is a FRESH crossover signal, not a historical state.
        # The second of the two required crossovers must have happened recently.
        # This prevents an old crossover from continuing to show BUY/SELL.
        core_buy = (
            b21_i is not None
